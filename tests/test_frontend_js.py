...
@pytest.mark.parametrize("suite", ["armyeye_ui.test.mjs", "admin_users_render.test.mjs", "pipeline_builder_roundtrip.test.mjs", "frontend_api_contracts.test.mjs", "form_payload_audit.test.mjs", "video_upload_selection.test.mjs", "camera_credentials_autofill.test.mjs"])
