...
class NodeTelemetry:
    ...
    def __init__(self, node_id: str):
        try:
            ...
            _ps.cpu_percent(interval=None)  # prime the non-blocking sampler
        except Exception:
            pass
    ...
    def get_system_info(self) -> Dict[str, Any]:
        ...
        try:
            ...
            # interval=None: non-blocking sample since the previous call (primed at init).
            # interval=1 blocked a server worker for a full second per /api/telemetry poll.
